...
export function mondayItemToPatient(item: MondayItem): Patient {
  ...
  return {
    ...
    cgmOrderDate: txt(COL.cgmOrderDate),
    sensorsOrderDate: txt(COL.sensorsOrderDate),
    ipOrderDate: txt(COL.ipOrderDate),
    infusionSetOrderDate: txt(COL.infusionSetOrderDate),
    cartridgeOrderDate: txt(COL.cartridgeOrderDate),
    suppliesOrderDate: txt(COL.suppliesOrderDate),
