...
export function mondayItemToPatient(item: MondayItem): Patient {
  ...
  return {
    ...
    planName: txt(COL.planName),
    orderFrequency: txt(COL.orderFrequency),
    orderFrequencyEdited: null,
    ...
    cgmAuthUnits: txt(COL.cgmAuthUnits),
    sensorsAuthUnits: txt(COL.sensorsAuthUnits),
    ipAuthUnits: txt(COL.ipAuthUnits),
    infusionSetAuthUnits: txt(COL.infusionSetAuthUnits),
    cartridgeAuthUnits: txt(COL.cartridgeAuthUnits),
    pos: txt(COL.pos),
